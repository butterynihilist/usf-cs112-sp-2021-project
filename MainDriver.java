...
public class MainDriver {
	public static void main(String[] args) {
		...
		ArrayList<DataPoint> dataPoint = dummy.readData("/Users/berkeleyp/eclipse-workspace/DataAnalytics1/src/DataFile.txt");
		...
		contentPane.add(new JButton(new ImageIcon("/Users/berkeleyp/eclipse-workspace/usf-cs112-sp-2021-project/DataAnalytics/src/project1/sad_cat.png")));
